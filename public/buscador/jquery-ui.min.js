...
!(function (t) {
    ...
    (k.cleanData =
        ...
        (k.widget = function (t, i, e) {
            ...
            return (
                ...
                (n.prototype = k.widget.extend(o, { widgetEventPrefix: (s && o.widgetEventPrefix) || t }, a, { constructor: n, namespace: r, widgetName: t, widgetFullName: h })),
                s
        ...
        (k.Widget.prototype = {
            ...
            _on: function (n, o, t) {
                ...
                "boolean" != typeof n && ((t = o), (o = n), (n = !1)),
                    t ? ((o = a = k(o)), (this.bindings = this.bindings.add(o))) : ((t = o), (o = this.element), (a = this.widget())),
    ...
    (k.ui.focusable = function (t, e) {
        ...
        return "area" === a
            ? ((s = (i = t.parentNode).name), !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && 0 < (s = k("img[usemap='#" + s + "']")).length && s.is(":visible"))
            : (/^(input|select|textarea|button|object)$/.test(a) ? (n = !t.disabled) && (o = k(t).closest("fieldset")[0]) && (n = !o.disabled) : (n = ("a" === a && t.href) || e),
              n &&
                  k(t).is(":visible") &&
                  (function (t) {
        ...
        (k.fn.labels = function () {
            ...
            return this[0].labels && this[0].labels.length
                ...
                : ((e = this.eq(0).parents("label")),
                  (t = this.attr("id")) && ((i = (i = this.eq(0).parents().last()).add((i.length ? i : this).siblings())), (t = "label[for='" + k.ui.escapeSelector(t) + "']"), (e = e.add(i.find(t).addBack(t)))),
                  this.pushStack(e));
        }),
                ...
                s.containment
                    ? "window" !== s.containment
                        ? "document" !== s.containment
                            ...
                            : (this.containment = [0, 0, k(n).width() - this.helperProportions.width - this.margins.left, (k(n).height() || n.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top])
                        : (this.containment = [
            ...
            drag: function (t, e, i) {
                for (var s, n, o, a, r, h, l, c, u, d = i.options, p = d.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--)
                    (h = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width),
                        ...
                        g < r - p || h + p < f || _ < l - p || c + p < m || !k.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item)
                            ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, k.extend(i._uiHash(), { snapItem: i.snapElements[v].item })), (i.snapElements[v].snapping = !1))
                            : ("inner" !== d.snapMode &&
                                  ((s = Math.abs(l - _) <= p),
                                  (n = Math.abs(c - m) <= p),
                                  (o = Math.abs(r - g) <= p),
                              ...
                              "outer" !== d.snapMode &&
                                  ...
                                  a && (e.position.left = i._convertPositionTo("relative", { top: 0, left: h - i.helperProportions.width }).left)),
                              !i.snapElements[v].snapping && (s || n || o || a || u) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, k.extend(i._uiHash(), { snapItem: i.snapElements[v].item })),
                ...
                (this.element
                    ...
                    .each(function () {
                        ...
                        if (
                            ...
                            p(i, k.extend(t, { offset: t.element.offset() }), t.options.tolerance, e)
                        )
                            return !(s = !0);
                    }),
            ...
            n.options.refreshPositions && k.ui.ddmanager.prepareOffsets(n, o),
                k.each(k.ui.ddmanager.droppables[n.options.scope] || [], function () {
                    ...
                    this.options.disabled ||
                        this.greedyChild ||
                        !this.visible ||
                        ((s = !(i = p(n, this, this.options.tolerance, o)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) &&
                            (this.options.greedy &&
    ...
    k.widget("ui.resizable", k.ui.mouse, {
            ...
            (this._renderAxis = function (t) {
                ...
                for (e in ((t = t || this.element), this.handles))
                    this.handles[e].constructor === String
                        ...
                        : (this.handles[e].jquery || this.handles[e].nodeType) && ((this.handles[e] = k(this.handles[e])), this._on(this.handles[e], { mousedown: a._mouseDown })),
                        this.elementIsWrapper &&
        ...
        _mouseStart: function (t) {
            ...
            return (
                ...
                s.containment && ((e += k(s.containment).scrollLeft() || 0), (i += k(s.containment).scrollTop() || 0)),
        ...
        _mouseDrag: function (t) {
            ...
            return (
                ...
                i &&
                    ...
                    k.isEmptyObject(e) || (this._updatePrevProperties(), this._trigger("resize", t, this.ui()), this._applyChanges())),
                !1
            );
        },
        _mouseStop: function (t) {
        ...
        k.ui.plugin.add("resizable", "containment", {
                ...
                a &&
                    ...
                    /document/.test(o) || o === document
                        ? ((n.containerOffset = { left: 0, top: 0 }),
                          ...
                          (n.parentData = { element: k(document), left: 0, top: 0, width: k(document).width(), height: k(document).height() || document.body.parentNode.scrollHeight }))
                        : ((i = k(a)),
                          (s = []),
            ...
            stop: function () {
                ...
                t._helper && !e.animate && /relative/.test(n.css("position")) && k(this).css({ left: a.left - s.left - i.left, width: r, height: o }),
                    t._helper && !e.animate && /static/.test(n.css("position")) && k(this).css({ left: a.left - s.left - i.left, width: r, height: o });
            },
        }),
                ...
                (i.grid = r),
                    ...
                    /^(se|s|e)$/.test(a)
                        ...
                        : ((p - l <= 0 || d - h <= 0) && (t = e._getPaddingPlusBorderDimensions(this)),
                          0 < p - l ? ((e.size.height = p), (e.position.top = o.top - u)) : ((p = l - t.height), (e.size.height = p), (e.position.top = o.top + n.height - p)),
                          0 < d - h ? ((e.size.width = d), (e.position.left = o.left - c)) : ((d = h - t.width), (e.size.width = d), (e.position.left = o.left + n.width - d)));
            },
        });
    k.ui.resizable,
        ...
        k.widget("ui.sortable", k.ui.mouse, {
                ...
                for (
                    ...
                    if (
                        ...
                        (n = this._intersectsWithPointer(i)) &&
                            ...
                            !(s === this.currentItem[0] || this.placeholder[1 === n ? "next" : "prev"]()[0] === s || k.contains(this.placeholder[0], s) || ("semi-dynamic" === this.options.type && k.contains(this.element[0], s))))
                    ) {
                    ...
                    for (e = r.length - 1; 0 <= e; e--)
                        for (i = (s = k(r[e], this.document[0])).length - 1; 0 <= i; i--)
                            (n = k.data(s[i], this.widgetFullName)) &&
                                n !== this &&
                                !n.options.disabled &&
                                a.push([k.isFunction(n.options.items) ? n.options.items.call(n.element) : k(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n]);
                function h() {
                    o.push(this);
                }
                for (
            ...
            _refreshItems: function (t) {
                ...
                for (e = c.length - 1; 0 <= e; e--) for (o = c[e][1], i = 0, h = (a = c[e][0]).length; i < h; i++) (r = k(a[i])).data(this.widgetName + "-item", o), l.push({ item: r, instance: o, width: 0, height: 0, left: 0, top: 0 });
            },
            refreshPositions: function (t) {
                var e, i, s, n;
                for (
                    this.floating = !!this.items.length && ("x" === this.options.axis || this._isFloating(this.items[0].item)), this.offsetParent && this.helper && (this.offset.parent = this._getParentOffset()), e = this.items.length - 1;
                    0 <= e;
                    e--
                )
                ...
                for (var e, i, s, n, o, a, r, h, l, c = null, u = null, d = this.containers.length - 1; 0 <= d; d--)
                    k.contains(this.currentItem[0], this.containers[d].element[0]) ||
                        (this._intersectsWith(this.containers[d].containerCache)
                            ? (c && k.contains(this.containers[d].element[0], c.element[0])) || ((c = this.containers[d]), (u = d))
                    ...
                    if (1 === this.containers.length) this.containers[u].containerCache.over || (this.containers[u]._trigger("over", t, this._uiHash(this)), (this.containers[u].containerCache.over = 1));
                        ...
                        for (i = 1e4, s = null, n = (h = c.floating || this._isFloating(this.currentItem)) ? "left" : "top", o = h ? "width" : "height", l = h ? "pageX" : "pageY", e = this.items.length - 1; 0 <= e; e--)
                            k.contains(this.containers[u].element[0], this.items[e].item[0]) &&
                                ...
                                ((a = this.items[e].item.offset()[n]), (r = !1), t[l] - a > this.items[e][o] / 2 && (r = !0), Math.abs(t[l] - a) < i && ((i = Math.abs(t[l] - a)), (s = this.items[e]), (this.direction = r ? "up" : "down")));
            ...
            _createHelper: function (t) {
                ...
                return (
                    t.parents("body").length || k("parent" !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(t[0]),
                ...
                this._on(this.menu.element, {
                    ...
                    menufocus: function (t, e) {
                        ...
                        (i = e.item.data("ui-autocomplete-item")),
                            ...
                            (i = e.item.attr("aria-label") || i.value) && k.trim(i).length && (this.liveRegion.children().hide(), k("<div>").text(i).appendTo(this.liveRegion));
                    },
                        ...
                        : void (
                              ...
                              o.element.find(t).each(function () {
                                  ...
                                  ("button" === s && t.parent(".ui-spinner").length) ||
                                      ((e = e || t[s]()[s]("instance")) && (i.classes = o._resolveClassesValues(i.classes, e)), t[s](i), (i = t[s]("widget")), k.data(i[0], "ui-controlgroup-data", e || t[s]("instance")), a.push(i[0]));
                              }))
                          );
            }),
    ...
    k.widget("ui.button", {
        ...
        _updateIcon: function (t, e) {
            var i = "iconPosition" !== t,
                ...
                t = "top" === s || "bottom" === s;
            this.icon ? i && this._removeClass(this.icon, null, this.options.icon) : ((this.icon = k("<span>")), this._addClass(this.icon, "ui-button-icon", "ui-icon"), this.options.showLabel || this._addClass("ui-button-icon-only")),
    ...
    function y() {
        k.datepicker._isDisabledDatepicker((_.inline ? _.dpDiv.parent() : _.input)[0]) ||
        ...
        k.extend(v.prototype, {
            ...
            _attachments: function (t, e) {
                ...
                e.append && e.append.remove(),
                    s && ((e.append = k("<span class='" + this._appendClass + "'>" + s + "</span>")), t[n ? "before" : "after"](e.append)),
                    ...
                    ("button" !== i && "both" !== i) ||
                        ...
                        (e.trigger = k(
                            this._get(e, "buttonImageOnly")
                                ? k("<img/>").addClass(this._triggerClass).attr({ src: i, alt: s, title: s })
                                : k("<button type='button'></button>")
                                      .addClass(this._triggerClass)
                                      .html(i ? k("<img/>").attr({ src: i, alt: s, title: s }) : s)
                        )),
            ...
            _doKeyDown: function (t) {
                ...
                if (((s._keyEvent = !0), k.datepicker._datepickerShowing))
                    switch (t.keyCode) {
                        ...
                        case 13:
                            return (
                                (i = k("td." + k.datepicker._dayOverClass + ":not(." + k.datepicker._currentClass + ")", s.dpDiv))[0] && k.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, i[0]),
                                (e = k.datepicker._get(s, "onSelect")) ? ((i = k.datepicker._formatDate(s)), e.apply(s.input ? s.input[0] : null, [i, s])) : k.datepicker._hideDatepicker(),
                                !1
                            );
                        case 27:
                            k.datepicker._hideDatepicker();
            ...
            _doKeyPress: function (t) {
                ...
                if (k.datepicker._get(i, "constrainInput"))
                    return (e = k.datepicker._possibleChars(k.datepicker._get(i, "dateFormat"))), (i = String.fromCharCode(null == t.charCode ? t.keyCode : t.charCode)), t.ctrlKey || t.metaKey || i < " " || !e || -1 < e.indexOf(i);
            },
            _doKeyUp: function (t) {
            ...
            _showDatepicker: function (t) {
                ...
                "input" !== (t = t.target || t).nodeName.toLowerCase() && (t = k("input", t.parentNode)[0]),
                    k.datepicker._isDisabledDatepicker(t) ||
                        ...
                        k.datepicker._curInst && k.datepicker._curInst !== n && (k.datepicker._curInst.dpDiv.stop(!0, !0), n && k.datepicker._datepickerShowing && k.datepicker._hideDatepicker(k.datepicker._curInst.input[0])),
                        !1 !== (i = (s = k.datepicker._get(n, "beforeShow")) ? s.apply(t, [t, n]) : {}) &&
                            (w(n.settings, i),
                            (n.lastVal = null),
                            (k.datepicker._lastInput = t),
                            ...
                            n.dpDiv.css({ position: k.datepicker._inDialog && k.blockUI ? "static" : e ? "fixed" : "absolute", display: "none", left: s.left + "px", top: s.top + "px" }),
                            n.inline ||
            ...
            _checkExternalClick: function (t) {
                ...
                k.datepicker._curInst &&
                    ...
                    ((e[0].id === k.datepicker._mainDivId ||
                        ...
                        (!e.hasClass(k.datepicker.markerClassName) || k.datepicker._curInst === t)) ||
                        k.datepicker._hideDatepicker());
            },
            ...
            _selectDay: function (t, e, i, s) {
                ...
                k(s).hasClass(this._unselectableClass) ||
                    ...
                    (((n = this._getInst(n[0])).selectedDay = n.currentDay = k("a", s).html()),
            ...
            parseDate: function (e, n, t) {
                ...
                for (
                    var r,
                        ...
                        f = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort,
                    ...
                    t =
                        null == t || "" === t
                            ...
                            ? (function (t) {
                                  ...
                                  for (
                                      var e = (t.toLowerCase().match(/^c/) ? k.datepicker._getDate(r) : null) || new Date(), i = e.getFullYear(), s = e.getMonth(), n = e.getDate(), o = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, a = o.exec(t);
                                      a;
                ...
                for (
                    t.drawMonth = q,
                        ...
                        i = this._canAdjustMonth(t, -1, K, q)
                            ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "e" : "w") + "'>" + R + "</span></a>"
                            : W
                            ? ""
                            : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "e" : "w") + "'>" + R + "</span></a>",
                        R = this._get(t, "nextText"),
                        R = E ? this.formatDate(R, this._daylightSavingAdjust(new Date(K, q + z, 1)), this._getFormatConfig(t)) : R,
                        s = this._canAdjustMonth(t, 1, K, q)
                            ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "w" : "e") + "'>" + R + "</span></a>"
                            : W
                            ? ""
                            : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + R + "'><span class='ui-icon ui-icon-circle-triangle-" + (A ? "w" : "e") + "'>" + R + "</span></a>",
                        ...
                        E = N
                            ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" +
                              (A ? E : "") +
                              (this._isInRange(t, R) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + W + "</button>" : "") +
                              (A ? "" : E) +
                              "</div>"
                            : "",
                    ...
                    for (_ = "", this.maxRows = 4, v = 0; v < F[1]; v++) {
                        ...
                        for (
                            y +=
                                ...
                                this._generateMonthYearHeader(t, q, K, Y, j, 0 < m || 0 < v, h, l) +
                        ...
                        for (
                            ...
                            for (y += "<tr>", P = o ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(I) + "</td>" : "", g = 0; g < 7; g++)
                                (M = c ? c.apply(t.input ? t.input[0] : null, [I]) : [!0, ""]),
                                    ...
                                    (P +=
                                        ...
                                        ((I.getTime() === b.getTime() && q === t.selectedMonth && t._keyEvent) || (p.getTime() === I.getTime() && p.getTime() === b.getTime()) ? " " + this._dayOverClass : "") +
                                        (H ? " " + this._unselectableClass + " ui-state-disabled" : "") +
                                        (S && !u ? "" : " " + M[1] + (I.getTime() === B.getTime() ? " " + this._currentClass : "") + (I.getTime() === O.getTime() ? " ui-datepicker-today" : "")) +
                                        "'" +
                                        ((S && !u) || !M[2] ? "" : " title='" + M[2].replace(/'/g, "&#39;") + "'") +
                                        (H ? "" : " data-handler='selectDay' data-event='click' data-month='" + I.getMonth() + "' data-year='" + I.getFullYear() + "'") +
                                        ">" +
                                        (S && !u
                                            ? "&#xa0;"
                                            : H
                                            ...
                                            : "<a class='ui-state-default" +
                                              (I.getTime() === O.getTime() ? " ui-state-highlight" : "") +
                                              (I.getTime() === B.getTime() ? " ui-state-active" : "") +
            ...
            k.ui.formResetMixin,
            {
                ...
                _renderMenu: function (s, t) {
                    ...
                    k.each(t, function (t, e) {
                        var i;
                        e.optgroup !== o &&
                            ((i = k("<li>", { text: e.optgroup })), n._addClass(i, "ui-selectmenu-optgroup", "ui-menu-divider" + (e.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : "")), i.appendTo(s), (o = e.optgroup)),
                          ...
                          (i = ((r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin())) * 100),
                              ...
                              !0 === r.options.range &&
                                  ("horizontal" === r.orientation
                                      ? (0 === t && r.range.stop(1, 1)[h ? "animate" : "css"]({ left: i + "%" }, a.animate), 1 === t && r.range[h ? "animate" : "css"]({ width: i - e + "%" }, { queue: !1, duration: a.animate }))
                                      : (0 === t && r.range.stop(1, 1)[h ? "animate" : "css"]({ bottom: i + "%" }, a.animate), 1 === t && r.range[h ? "animate" : "css"]({ height: i - e + "%" }, { queue: !1, duration: a.animate }))),
                              (e = i);
                      })
                    : ((t = this.value()),
                      (s = this._valueMin()),
            ...
            (this.tablist = this._getList().attr("role", "tablist")),
                ...
                this.anchors.each(function (t, e) {
                    ...
                    h._isLocal(e)
                        ...
                        : ((i = "#" + (n = a.attr("aria-controls") || k({}).uniqueId()[0].id)), (s = h.element.find(i)).length || (s = h._createPanel(n)).insertAfter(h.panels[t - 1] || h.tablist), s.attr("aria-live", "polite")),
            ...
            i &&
                ((s = this._find(e))
                    ...
                    : (e.is("[title]") && (t && "mouseover" === t.type ? e.attr("title", "") : e.removeAttr("title")),
                      ...
                      this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, { mousemove: r }), r(t)) : n.position(k.extend({ of: e }, this.options.position)),
                      n.hide(),
    ...
    (k.effects = { effect: {} }),
                        ...
                        (N.fn[a] = function (t) {
                            ...
                            return "undefined" === i
                                ...
                                : ("function" === i && ((t = t.call(this, o)), (i = S.type(t))),
                                  null == t && r.empty ? this : ("string" === i && (e = O.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)), (n[r.idx] = t), this[s](n)));
                        });
                });
        }),
        (N.hook = function (t) {
        ...
        (k.fx.step.clip = function (t) {
            t.clipInit || ((t.start = k(t.elem).cssClip()), "string" == typeof t.end && (t.end = at(t.end, t.elem)), (t.clipInit = !0)),
                k(t.elem).cssClip({
    ...
    k.effects.define("blind", "hide", function (t, e) {
        ...
        (a.clip[i[n][0]] = a.clip[i[n][1]]),
            "show" === t.mode && (s.cssClip(a.clip), r && r.css(k.effects.clipToBox(a)), (a.clip = o)),
        ...
        k.effects.define("drop", "hide", function (t, e) {
            ...
            k.effects.createPlaceholder(i),
                ...
                i.animate(h, { queue: !1, duration: t.duration, easing: t.easing, complete: e });
        }),
        ...
        k.effects.define("size", function (s, e) {
            ...
            k.effects.createPlaceholder(i),
                ...
                ("box" !== l && "both" !== l) ||
                    (n.from.y !== n.to.y && ((f = k.effects.setTransition(i, o, n.from.y, f)), (g = k.effects.setTransition(i, o, n.to.y, g))),
                    n.from.x !== n.to.x && ((f = k.effects.setTransition(i, a, n.from.x, f)), (g = k.effects.setTransition(i, a, n.to.x, g)))),
                ("content" !== l && "both" !== l) || (n.from.y !== n.to.y && ((f = k.effects.setTransition(i, t, n.from.y, f)), (g = k.effects.setTransition(i, t, n.to.y, g)))),
                c &&
                ...
                ("content" !== l && "both" !== l) ||
                    ...
                    i.find("*[width]").each(function () {
                        ...
                        n.from.y !== n.to.y && ((i = k.effects.setTransition(t, o, n.from.y, i)), (e = k.effects.setTransition(t, o, n.to.y, e))),
                            n.from.x !== n.to.x && ((i = k.effects.setTransition(t, a, n.from.x, i)), (e = k.effects.setTransition(t, a, n.to.x, e))),
        ...
        k.effects.define("slide", "show", function (t, e) {
            ...
            k.effects.createPlaceholder(n),
                ...
                "show" === a && (n.cssClip(u.clip), n.css(h, u[h]), (u.clip = i), (u[h] = s)),
